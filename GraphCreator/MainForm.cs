...
namespace GraphCreator
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            //            Project.Edges.Add(new Edge(vertex1, vertex2) { HasWeight = true, Weight = generateWeight() });
            //    }
            ...
            //            Project.Edges.Add(new Edge(connectedItem, notConnectedItem) { HasWeight = true, Weight = generateWeight() });
            //    }
            //}
